...
function calcularSimulacion(event) {
  ...
  `;
    ...
    emailjs.init('insertar token aqui')
  ...
  document.getElementById('form')
   .addEventListener('submit', function(event) {
     ...
     const serviceID = 'insertar tu service Id de EmailJS';
     const templateID = 'Insertar tu Template Id de EmailJS';
...
function redireccionar() {
  ...
  window.location.href = 'Insertar link a donde te dirige';
}
